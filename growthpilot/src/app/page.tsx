  ...
  return (
    <div>
      <SectionHeader
        ...
        subtitle={`Last updated today · ${mockGrowthScore.trend}`}
        icon="🏠"
      />
      ...
      <div className="bg-gradient-to-br from-violet-900/40 to-blue-900/40 border border-violet-800/50 rounded-2xl p-8 mb-8 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="bg-slate-900/60 rounded-xl p-5 text-center min-w-[160px]">
          <div className="text-4xl font-bold text-violet-400 mb-1">{mockGrowthScore.overall}</div>
          ...
          <Link
            href="/ai-engine"
            className="mt-3 block text-xs bg-violet-600 hover:bg-violet-500 text-white px-3 py-1.5 rounded-lg transition-colors"
          >
            View AI Engine →
          </Link>
        </div>
      ...
      <h2 className="text-lg font-semibold text-white mb-4">Top Priority Actions</h2>
